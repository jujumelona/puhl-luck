...
try:
    ...
    RUST_AVAILABLE = True
    logger.info("Rust acceleration available: using puhl_luck_core for HDC operations (10-26x speedup)")
except ImportError as e:
    RUST_AVAILABLE = False
    logger.info(f"Rust acceleration not available: falling back to Python implementations. Import error: {e}")
    logger.debug("To enable Rust acceleration, build the rust_core package with 'maturin develop --release'")
